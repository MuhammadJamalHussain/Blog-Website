...
export default function blogPage({params}:any){
    ...
    const blogs : {
        ...
        {
        name : "Blog1",
        image : <Image src="/AI2.jfif" alt="data" width={800} height={500} style={{margin:"150px", borderRadius: "20px"}}/>,
        ...
        {
        name : "Blog2",
        image : <Image src="/CS2.jfif" alt="CS" width={800} height={500} style={{margin:"150px", borderRadius: "20px"}} />,
        ...
        {
        name : "Blog3",
        image : <Image src="/BCW.jfif" alt="BlockChain" width={800} height={500} style={{  margin:"150px", borderRadius: "20px"}} />,
        ...
        {
        name : "Blog4",
        image : <Image src="/CC.png" alt="CC" width={800} height={500} style={{  margin:"150px", borderRadius: "20px"}} />,
        ...
        {
         name : "Blog5",
         image : <Image src="/QC2.jfif" alt="QC" width={800} height={500} style={{  margin:"150px", borderRadius: "20px"}} />,
        ...
        {
        name : "Blog6",
        image : <Image src="/ER2.jfif" alt="ER" width={800} height={500} style={{  margin:"150px", borderRadius: "20px"}} />,
